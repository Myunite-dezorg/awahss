# Generated by Django 4.1.4 on 2023-02-14 20:53
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=apps.directory.models.airline_banner_directory_path,
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "co",
                    models.CharField(default="", max_length=5, verbose_name="Company"),
                ),
                (
                    "mod",
                    models.CharField(
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=apps.directory.models.register_photo_directory_path,
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iata",
                    models.CharField(default="", max_length=3, verbose_name="IATA"),
                ),
                (
                    "icao",
                    models.CharField(default="", max_length=4, verbose_name="ICAO"),
                ),
                ("rus", models.CharField(default="", max_length=5, verbose_name="Rus")),
                (
                    "comment_eng",
                    models.CharField(
                        default="", max_length=50, verbose_name="Comment Eng"
                    ),
                ),
                (
                    "comment_rus",
                    models.CharField(
                        default="", max_length=50, verbose_name="Comment Rus"
                    ),
                ),
                (
                    "country",
                ...
                (
                    "city_r",
                    models.CharField(default="", max_length=50, verbose_name="Sity R"),
                ),
                (
                    "airport_e",
                    models.CharField(
                        default="", max_length=50, verbose_name="Airport E"
                    ),
                ),
                (
                    "region",
                ...
                (
                    "airport_r",
                    models.CharField(
                        default="", max_length=50, verbose_name="Airport R"
                    ),
                ),
                (
                    "city_e",
                    models.CharField(default="", max_length=50, verbose_name="City E"),
                ),
                (
                    "country_flag",
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=apps.directory.models.station_flag_directory_path,
                    ),
                ),
            ],
        ),
